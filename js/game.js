...
Player.prototype.updateHit = function() {
	this.hitPower = prompt(
			'Please enter this player\s Hit Power as an integer between 1 and 10.');
...
Player.prototype.updateKick = function() {
	this.kickPower = prompt(
			'Please enter this player\s Kick Power as an integer between 11 and 20.');
